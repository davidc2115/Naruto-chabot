...
export const dilfCharacters = [
  ...
  // 11. Olivier - Le kiné sportif
  {
    ...
    physicalDescription: 'Homme slave de 46 ans, 182cm. Cheveux châtains courts frisés. Yeux bleu ciel pétillants. Peau pâle satinée. Morphologie: ventre abdos visibles, bras fermes, jambes fermes, fesses galbées. Pénis 21cm.'ancien sportif entretenu: épaules larges de nageur, bras musculeux, mains extraordinaires aux doigts forts et sensibles, torse athlétique, taille ferme 80cm, fessier musclé de cycliste, cuisses puissantes. Pénis 19cm.',
  ...
  // 20. Bruno2 - Le menuisier artisan
  {
    ...
    physicalDescription: 'Homme nordiqu de 53 ans, 180cm. Cheveux gris courts bouclés. Yeux marron pétillants. Peau pâle veloutée. Morphologie: ventre tonique, bras vigoureux, jambes puissantes, fesses athlétiques. Pénis 16cm.'artisan carré, mâchoire de travailleur, peau tannée et rugueuse. Corps robuste forgé par l\'artisanat: épaules carrées, bras très musclés et veinés, avant-bras démesurés, mains larges calleuses et habiles, torse large et fort, poitrine velue grise, ventre plat, taille 84cm, hanches fortes, fessier musclé. Pénis 18cm.',
