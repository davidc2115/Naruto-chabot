...
export const fantasyCharacters = [
  ...
  },
  {
    ...
    physicalDescription: 'Elfe mâle 450 ans apparence 30, 190cm 78kg, longs cheveux blonds  lissesdorés, yeux dor en amandeés perçants, oreilles pointues, cicatrice joue, corps athlétique musclé, pénis 20cm elfique',
  ...
  // ==================== VAMPIRES ====================
  {
    ...
    physicalDescription: 'Vampire femme 500 ans apparence 28, 175cm 58kg, longs cheveux noir corbeau ondulés, yeux rouge en amande sang hypnotiques, canines légèrement allongées, visage parfait glacial aristocratique, peau de satinée porcelaine pâle froide, corps voluptueux dangereux, poitrine généreuse ferme, taille fine 60cm, hanches larges sensuelles, fessier rond, longues jambes',
  ...
  },
  {
    ...
    physicalDescription: 'Vampire masculin 800 ans apparence 32, 188cm 85kg, cheveux noir  ondulésde jais mi-longs, yeux rouge ronds sang hypnotiques, visage ciselé immortel, peau blanche douce parfaite froide, corps puissant de seigneur vampire, épaules larges de seigneur, bras puissants veines anciennes, mains élégantes mortelles, torse de marbre sculptural, taille étroite 78cm, fessier puissant, jambes fortes, pénis 22cm impressionnant',
  ...
  // ==================== SUCCUBES / INCUBES ====================
  {
    ...
    physicalDescription: 'Succube immortelle apparence 26 ans, 175cm 58kg, cheveux violet foncé très longs ondulés, yeux dor grandsés félins hypnotiques pupilles verticales, petites cornes élégantes, visage surnaturellement beau, peau caramel douce dorée phosphorescente, queue fine pointe en cœur, ailes repliées, corps de rêve parfait, poitrine DD parfaite surnaturellement ferme, taille de guêpe 54cm, hanches larges sensuelles, fessier rond parfait haut, jambes longues galbées',
    height: '170cm',
  ...
  },
  {
    ...
    physicalDescription: 'Homme de 25 ans, 185cm. Cheveux noirs courts lisses. Yeux verts en amande. Visage carré, mâchoire marquée, visage rasé de près, peau claire soyeuse. Corps bien bâti: épaules carrées, torse masculin, bras fermes, jambes musclées. Pénis 20cm.',
  ...
  // ==================== ANGES ====================
  {
    ...
    physicalDescription: 'Ange femme éternelle apparence 24, 172cm 50kg, cheveux blanc longs frisés-doré, yeux bleu ronds ciel innocents, peau lumineuse soyeuse, grandes ailes blanches grisées, corps gracieux fin, poitrine moyenne',
  ...
  },
  {
    ...
    physicalDescription: 'Archange mâle éternel apparence 30, 195cm 90kg, cheveux blancs courts lisses, yeux or ronds, peau dor douceée, grandes ailes blanches, armure divine, corps puissant noble, pénis 21cm divin',
    hairColor: 'Blanc',
    eyeColor: 'Or',
    height: '195cm',
  ...
  // ==================== DÉMONS ====================
  {
    ...
    physicalDescription: 'Démone millénaire apparence 27, 176cm 62kg, cheveux noirs courts bouclés flamme, yeux jaunes grands fendus, cornes imposantes, queue diable, ailes chauve-souris, peau rouge veloutée sombre, corps voluptueux, poitrine très généreuse',
  ...
  },
  {
    ...
    physicalDescription: 'Prince démon millénaire apparence 35, 200cm 120kg, cheveux blancs longs lisses, yeux rouges grands brûlants, grandes cornes, ailes dragon, peau gris satinée charbon, corps massif, pénis 26cm démoniaque',
    hairColor: 'Blanc',
  ...
  // ==================== LOUP-GAROU ====================
  {
    ...
    physicalDescription: 'Loup-garou femme 28 ans, 175cm 65kg, cheveux argent courts lissesés sauvages, yeux ambr en amandeés de loup, canines prononcées, corps athlétique musclé, poitrine moyenne ferme, cicatrices combat',
  ...
  },
  {
    ...
    physicalDescription: 'Loup-garou homme 32 ans, 193cm 105kg, cheveux noirs longs lisses hirsutes, yeux jaunes grands de loup, barbe 3 jours, corps massif musclé, cicatrices torse, pénis 23cm sauvage',
  ...
  // ==================== SORCIÈRES / SORCIERS ====================
  {
    ...
    physicalDescription: 'Sorcière 35 ans, 168cm 65kg, longs cheveux roux bouclés, yeux verts ronds de chat, peau olive veloutée taches de rousseur, corps généreux sensuel, poitrine généreuse',
  ...
  },
  {
    ...
    physicalDescription: 'Mage immortel apparence 40, 183cm 75kg, cheveux gris longs bouclés argent, yeux bleu ronds électrique, barbe soignée, mains runiques, corps élancé fort, pénis 19cm magique',
  ...
  // ==================== CRÉATURES MYTHIQUES ====================
  {
    ...
    physicalDescription: 'Sirène femme 200 ans apparence 23, 165cm 50kg, longs cheveux bleu-vert, yeux turquoise ronds, peau iris veloutéeée, corps gracieux fin, poitrine moyenne de sirène, queue écailles bleues ou jambes',
    hairColor: 'Bleu-vert',
    eyeColor: 'Turquoise',
  ...
  },
  {
    ...
    physicalDescription: 'Homme de 25 ans, 220cm. Cheveux bruns longs frisés. Yeux noisette grands. Visage ovale, mâchoire marquée, visage rasé de près, peau claire soyeuse. Corps athlétique et musclé: épaules larges, pectoraux développés, abdos visibles, bras puissants, jambes musclées. Pénis 21cm.',
        outfit: 'run long',
    eyeColor: 'Noisette',
  ...
  },
  {
    ...
    physicalDescription: 'Fée femme 100 ans apparence 20, 155cm humaine ou 15cm fée, cheveux roses mi-longs lisses, yeux multicolores grands, peau lumineuse satinée, ailes papillon irisées, corps menu gracieux, poitrine petite',
    hairColor: 'Rose',
