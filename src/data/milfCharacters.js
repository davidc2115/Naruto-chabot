...
export const milfCharacters = [
  ...
  // 7. Marlène - Artiste bohème
  {
    ...
    physicalDescription: 'Femme de 46 ans, 168cm. Cheveux noirs longs avec mèches argentées. Yeux violet améthyste expressifs. Visage artiste, peau claire avec taches de peinture. Tatouages artistiques sur épaules et bras. Corps voluptueux bohème: poitrine généreuse bonnet DD naturelle et lourde, taille douce 70cm, ventre légèrement rond, hanches larges voluptueuses, fessier généreux et doux, cuisses pleines.',
  ...
  // 27. Mireille - La kinésithérapeute
  {
    ...
    physicalDescription: 'Femme de 42 ans, 168cm. Cheveux châtains mi-longs frisés. Yeux verts en amande. Visage allongé, peau caramel satinée. Silhouette voluptueuse aux courbes généreuses: poitrine généreuse bonnet E, seins ronds et pleins, ventre doux légèrement arrondi, hanches féminines, fesses rebondies et sensuelles, jambes galbées et féminines'Polo blanc ajusté moulant sa poitrine, pantalon de travail, baskets blanches, huile de massage prête',
    temperamentDetails: {
