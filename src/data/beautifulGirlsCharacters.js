...
const beautifulGirlsCharacters = [
  // 1. Luna - La photographe bohème mystérieuse
  {
    ...
    physicalDescription: "24 ans, 172cm, élancée gracieuse, poitrine B cup petite et ferme, cheveux très longs raides noir de jais avec reflets bleutés, yeux gris en amande argenté hypnotiques, peau pâle douce porcelaine, visage fin féerique",
  ...
  // 2. Sofia - La danseuse latine passionnée
  {
    ...
    physicalDescription: "26 ans, 165cm, voluptueuse athlétique, poitrine D cup généreuse et ferme, cheveux longs ondulés brun acajou volumineux, yeux marron grands doré, peau caramel soyeuse doré, visage expressif, lèvres pulpeuses",
  ...
  // 3. Jade - La hackeuse rebelle
  {
    ...
    physicalDescription: "23 ans, 160cm, menue athlétique, poitrine A cup petite, cheveux carr mi-longs lissesé court asymétrique noir avec mèches vertes néon, yeux brun ronds foncé intenses, peau ivoire soyeuse, visage fin, piercing au nez",
  ...
  // 4. Aurora - La violoniste classique
  {
    ...
    physicalDescription: "27 ans, 175cm, élancée élégante, poitrine B cup modeste, cheveux longs lisses blond platine, yeux bleu ronds glacier perçants, peau très claire nordique, traits aristocratiques",
  ...
  // 5. Maya - La tatoueuse alternative
  {
    ...
    physicalDescription: "29 ans, 168cm, pulpeuse tatouée, poitrine DD cup très généreuse, cheveux mi-longs violet foncé avec undercut, yeux vert en amande olive, peau olive veloutée tatouée, piercing septum, traits marqués",
  ...
  // 6. Lily - L'infirmière bienveillante
  {
    ...
    physicalDescription: "25 ans, 163cm, douce et féminine, poitrine C cup moyenne, cheveux mi-longs ondulés châtain clair, yeux noisette en amande chaleureux, peau crème rosée, visage de poupée",
  ...
  // 7. Nina - La chef étoilée exigeante
  {
    ...
    physicalDescription: "32 ans, 170cm, athlétique tonique, poitrine B cup petite, cheveux courts  bouclésstructurés noir intense, yeux marron grands profond, peau mate douce méditerranéenne, traits forts et déterminés",
  ...
  // 8. Sakura - L'étudiante japonaise timide
  {
    ...
    physicalDescription: "21 ans, 158cm, petite et délicate, poitrine B cup petite et ronde, cheveux longs lisses noir profond avec frange, yeux noir ronds velouté, peau porcelaine lumineuse, visage ovale, traits fins",
  ...
  // 9. Eva - La coach de boxe
  {
    ...
    physicalDescription: "28 ans, 173cm, athlétique musclée, poitrine C cup ferme, cheveux longs  bouclésblond cendré en queue haute, yeux bleu ronds électrique, peau claire soyeuse bronzée, traits slaves, cicatrice au sourcil",
  ...
  // 10. Chloé - L'illustratrice rêveuse
  {
    ...
    physicalDescription: "22 ans, 162cm, menue et douce, poitrine A cup petite, cheveux courts  friséspixie rose pastel, yeux bleu ronds pervenche, lunettes rondes, peau très claire avec taches de rousseur",
  ...
  // 11. Victoria - L'avocate ambitieuse
  {
    ...
    physicalDescription: "31 ans, 176cm, élancée sophistiquée, poitrine C cup, cheveux longs  frisésauburn en chignon strict, yeux vert ronds émeraude perçants, peau ivoire soyeuse, traits aristocratiques",
  ...
  // 12. Amber - La surfeuse californienne
  {
    ...
    physicalDescription: "24 ans, 170cm, athlétique bronzée, poitrine C cup ferme, cheveux longs ondulés blond doré, yeux bleu en amande océan, peau bronz veloutéeée dorée, taches de rousseur solaires",
  ...
  // 13. Iris - La libraire mélancolique
  {
    ...
    physicalDescription: "28 ans, 165cm, douce et féminine, poitrine C cup, cheveux longs  bouclésbrun chocolat en tresse, yeux brun en amande doré mélancoliques, peau claire lumineuse, traits doux poétiques",
  ...
  // 15. Emma - La vétérinaire passionnée
  {
    ...
    physicalDescription: "29 ans, 167cm, naturelle harmonieuse, poitrine C cup, cheveux mi-longs bouclés roux cuivré, yeux vert ronds mousse, peau claire douce avec taches de rousseur, visage ovale",
  ...
  // 16. Leila - La danseuse de ballet
  {
    ...
    physicalDescription: "23 ans, 168cm, fine et gracieuse, poitrine B cup petite et ferme, cheveux très longs noir brillant en chignon, yeux marron grands velouté, peau ambr satinéeée lumineuse, traits fins, cou de cygne",
  ...
  // 17. Clara - La boulangère du village
  {
    ...
    physicalDescription: "27 ans, 164cm, douce et ronde, poitrine D cup pleine, cheveux mi-longs blond miel en chignon désordonné, yeux bleu ronds lavande, peau pêche veloutée, visage rond et joyeux",
  ...
  // 18. Naomi - La mannequin reconvertie
  {
    ...
    physicalDescription: "30 ans, 180cm, élancée de mannequin, poitrine B cup haute, cheveux longs ondulés brun foncé avec balayage caramel, yeux ambre ronds doré, peau café au lait satinée, visage parfait",
  ...
  // 20. Alice - La game designer créative
  {
    ...
    physicalDescription: "25 ans, 166cm, menue et vive, poitrine B cup petite, cheveux mi-longs bleu électrique en dégradé, yeux noisette ronds vifs, lunettes gaming, peau claire soyeuse, traits vifs et mutins",
